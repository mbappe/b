...
#CFLAGS = $(M) -g -O2 -Wall -std=c99 -pedantic -Wstrict-prototypes -Wmissing-prototypes -W -Werror
CFLAGS = $(M) -g -O2 -Wall -Werror
#CFLAGS = $(M) -O2 -Wall -Werror

#DEFINES += -DJUDYB -DNDEBUG -DSORT_LISTS -DSKIP_LINKS
#DEFINES += -DJUDYB -DNDEBUG -DSORT_LISTS -DSKIP_LINKS -DSKIP_PREFIX_CHECK
DEFINES += -DJUDYB -DNDEBUG -DSKIP_LINKS -DSKIP_PREFIX_CHECK
#DEFINES += -DJUDYB -DGUARDBAND -DSORT_LISTS -DSKIP_LINKS
